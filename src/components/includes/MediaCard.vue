    ...
    <div class="media-card rounded" v-if="media">
        <div class="media-card-wrapper">
            ...
            <div class="link-wrapper">
                ...
                <router-link v-else-if="media.media_type === 'show' && media['episodes'][0].file_path" :to="`/w?id=${media['episodes'][0].tmdbID}`" :title="`${media['episodes'][0].title}`" class="play-trigger"></router-link>
