...
function dbSetup() {
    ...
    const db = new sqlite3.Database('./database.db', (err) => {
        if (err) {
            ...
            function createMediaGenreTable() {
                return new Promise((resolve, reject) => {
            ...
            function createMediaWatchedTable() {
                return new Promise((resolve, reject) => {
            ...
            createSettingsTable()
            .then(() => {
                    console.log(`Tabelle "Settings" ${greenColor}erstellt${resetColor}.`);
                ...
                createUsersTable()
                .then(() => {
                    console.log(`Tabelle "Users" ${greenColor}erstellt.${resetColor}`);
                    ...
                    createGenreTable()
                    .then(() => {
                        console.log(`Tabelle "Genre" ${greenColor}erstellt${resetColor}.`);

                        createMediaTable()
                        .then(() => {
                            console.log(`Tabelle "Media" ${greenColor}erstellt${resetColor}.`);
                            
                            createSeasonsTable()
                            .then(() => {
                                console.log(`Tabelle "Seasons" ${greenColor}erstellt${resetColor}.`);
                                
                                createEpisodesTable()
                                .then(() => {
                                    console.log(`Tabelle "Episodes" ${greenColor}erstellt${resetColor}.`);
                                    
                                    createMediaGenreTable()
                                    .then(() => {
                                        console.log(`Tabelle "Media-Genre" ${greenColor}erstellt${resetColor}.`);
                                        
                                        createWatchlistTable()
                                        .then(() => {
                                            console.log(`Tabelle "Watchlist" ${greenColor}erstellt${resetColor}.`);
                                            
                                            createHighlightsTable()
                                            .then(() => {
                                                console.log(`Tabelle "Highlights" ${greenColor}erstellt${resetColor}.`);
                                                
                                                createMediaWatchedTable()
                                                .then(() => {
